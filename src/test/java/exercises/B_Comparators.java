...
public class B_Comparators {
    ...
    public void comparator01() {
        Comparator<String> compareByLength = Comparator.comparingInt(String::length); // TODO
    ...
    public void comparator02() {
        Comparator<String> compareByLengthThenAlphabetical = comparing(String::length).thenComparing(String.CASE_INSENSITIVE_ORDER); // TODO
    ...
    public void comparator03() {
        Comparator<Person> comparebyLastName = comparing(Person::getLastName); // TODO
    ...
    public void comparator04() {
        Comparator<Person> comparebyLastNameThenFirstName = comparing(Person::getLastName).thenComparing(Person::getFirstName); // TODO
    ...
    public void comparator05() {
        Comparator<Person> comparebyLastNameThenFirstNameReversed = comparing(Person::getLastName).thenComparing(Person::getFirstName).reversed(); // TODO
    ...
    public void comparator06() {
        Comparator<Person> comparebyLastNameThenFirstNameWithNull = nullsLast(comparing(Person::getLastName).thenComparing(Person::getFirstName));
    ...
    public void comparator07() {
        Comparator<Person> comparebyAge = comparingInt(Person::getAge); // TODO
    ...
    public void comparator08() {
        IntBinaryOperator intCompare = (a, b) -> a < b ? -1 : (a > b ? 1 : 0); // TODO
