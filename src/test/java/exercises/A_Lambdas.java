...
public class A_Lambdas {
    ...
    public void a_predicate1() {
        Predicate<String> pred = e -> e.length() > 4;
    ...
    public void a_predicate2() {
        Predicate<String> pred = e -> e.isEmpty(); // TODO
    ...
    public void a_predicate4() {
        ...
        Predicate<String> startsWithJAndLengthIs7 = e -> startsWithJ.and(lengthIs7).test(e); // TODO
    ...
    public void a_predicate5() {
        ...
        Predicate<String> lengthIs9orError = e -> equalsError.or(lengthIs9).test(e);
    ...
    public void b_function1() {
        Function<String, String> func = e -> "(" + e + ")"; // TODO
    ...
    public void b_function2() {
        Function<String, String> func = e -> e.toUpperCase(); // TODO
    ...
    public void c_consumer1() {
        Consumer<StringBuilder> cons = e -> e.append("abc"); // TODO
    ...
    public void c_consumer2() {
        Consumer<List<String>> cons = e -> e.clear(); // TODO
    ...
    public void e_bifunction2() {
        BiFunction<String, String, Integer> bifunc = (a, b) -> a.indexOf(b); // TODO
    ...
    public void g_boundMethodRef1() {
        Function<String, Integer> func = e -> "abcdefghij".indexOf(e); // TODO
